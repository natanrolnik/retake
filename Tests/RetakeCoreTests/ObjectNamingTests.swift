...
struct ObjectNamingTests {
    ...
    func runPrefix() {
        ...
        #expect(naming().runPrefix == "retake/pocketumpire/pr-42/20260813-195500-a1b2c3d")
    }
    ...
    func imageKeys() {
        ...
        #expect(key == "retake/pocketumpire/pr-42/20260813-195500-a1b2c3d/toss/tossview-toss-doubles.after.png")
    }
    ...
    func noPullRequest() {
        #expect(naming(pr: nil).runPrefix == "retake/pocketumpire/20260813-195500-a1b2c3d")
    }
}
